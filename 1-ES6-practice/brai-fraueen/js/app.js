...
function displayPics(){
  ...
  // From what stackoverflow said "Variables declared by const can mean that their scope the block in which they are defined, as well as in any contained sub-blocks that the scope of a var variable is the entire enclosing function. Meaning that it can only be used in its scope that its in.
  console.log(viewed);
